...
public class AuthServiceApiApplication implements CommandLineRunner {
	...
	private final ManagementMetadataProvider serviceManagementMetadataProvider;
	...
	public void run(String... args) throws Exception {
		...
		SystemUserRequestDto user1 =
				new SystemUserRequestDto("ABC", "XYZ", "abc@gmail.com", generator.generatePassword(), "0714911257");
